...
I've been working on pruning models [a](https://hbfreed.com/2026/01/28/variable-flexolmo.html) [bit](https://hbfreed.com/2026/01/05/pruning-olmo7b.html) lately, mainly based off of [this Nvidia paper](https://arxiv.org/abs/2407.14679). Mistral recently launched their [Ministral 3 models](https://huggingface.co/collections/mistralai/ministral-3), [which were pruned from Mistral Small 3.1](https://arxiv.org/pdf/2601.08584#section.1). In the Nvidia paper, they find that pruning width keeps performance better than pruning depth[^1]. 
